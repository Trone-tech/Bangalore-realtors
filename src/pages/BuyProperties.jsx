...
const BuyProperties = () => {
  ...
  const priceRanges = [
    ...
    { min: '0', max: '5000000', label: 'Under ₹50 Lacs' },
    { min: '5000000', max: '10000000', label: '₹50 Lacs - ₹1 Cr' },
    { min: '10000000', max: '20000000', label: '₹1 Cr - ₹2 Cr' },
    { min: '20000000', max: '30000000', label: '₹2 Cr - ₹3 Cr' },
    { min: '30000000', max: '', label: 'Above ₹3 Cr' }
  ];
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      ...
      try {
        // Only fetch properties for sale (listingType: 'sale')
        const allProperties = await propertyService.getAllProperties();
        
        // Filter properties by listingType = 'sale'
        let filteredProperties = allProperties.filter(prop => prop.listingType === 'sale');
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div>
          {loading ? (
            ...
            <>
              <p className="text-lg text-gray-600 mb-6">Found {properties.length} properties for sale</p>
